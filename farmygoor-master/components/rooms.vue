<template>
<div>
<h2 class="ma-5 white--text">Rooms</h2>
...
<v-card flat class="ma-3 cyan darken-4">
<v-responsive>
<v-img
  max-height="150"
  max-width="396"
...
<div class=" white--text"><h3>Room Available</h3>
</div>
...
<v-card-action>
<v-btn text class="white--text">Reserve</v-btn>
</v-card-action>
</v-card>
</v-flex>
</v-layout>
